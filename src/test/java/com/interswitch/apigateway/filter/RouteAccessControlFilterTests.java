...
@ContextConfiguration(classes = {RouteAccessControlFilter.class, FilterUtil.class})
public class RouteAccessControlFilterTests {

    @Autowired
    private RouteAccessControlFilter filter;
